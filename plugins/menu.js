...
❒ Mode : *Public*
❒ Browser *Chrome*
❒ Server : *Bailey-Md,Heroku*
❒ Version : *1.2.5*
❒ Handphone : *ROG Phone 5*
❒ Versi WhatsApp : *2.22.3.77*
┗━❒
┏━❒ 
❒ Hari : *%week %weton* 
❒ Tanggal : *%date*
    ...
    text = text.replace(new RegExp(`%(${Object.keys(replace).sort((a, b) => b.length - a.length).join`|`})`, 'g'), (_, name) => '' + replace[name])
     ...
     templateMessage: {
         hydratedTemplate: {
           ...
           locationMessage: { 
           jpegThumbnail: await (await fetch(`https://i.ibb.co/hgvQ4xr/tamnel.jpg`)).buffer() },
